/* चंद्रकैलाश Tours & Travels - Supabase / Central Cloud Database Service */

import { state, ensurePackagesHaveSlugsAndHeroProps } from '../context/state.js';

// Default Supabase project credentials (can be overridden via Admin Settings or window.ENV_SUPABASE_URL)
...
export function isSupabaseConfigured() {
    ...
    return Boolean(url && key && url.startsWith('http') && !url.includes('demo_key'));
}
